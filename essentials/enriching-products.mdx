...
`[Screenshot of the Products page with Enrich button highlighted]`
...
`[Screenshot of the enrichment type selection screen]`
...
`[Screenshot of the prompt selection interface with different prompt options]`
...
`[Screenshot showing enrichment progress with visual indicators]`
...
`[Screenshot showing before and after examples of enriched product content]` 