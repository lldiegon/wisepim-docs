...
<img 
  ...
  alt="Products page showing product selection options and the export button" 
/>

<img 
  src="/images/screenshots/products-actions.png" 
  alt="Products page with Export button highlighted in the actions toolbar" 
/>
...
<img 
  ...
  alt="Export modal showing platform selection options and configuration settings" 
/>
...
<img 
  src="/images/screenshots/integrations-configure.png" 
  alt="File export options modal showing CSV and Excel export settings" 
/>
