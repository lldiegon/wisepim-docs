...
<img 
  ...
  alt="Prompt Library interface showing the three-tab layout with different prompt collections" 
/>
...
<img 
  src="/images/screenshots/prompt-library-view-prompt.png" 
  alt="Prompt cards displaying all information elements including title, description, and metadata" 
/>
...
<img 
  src="/images/screenshots/prompt-library-curated.png" 
  alt="Save and duplicate process interface for managing prompts" 
/>
...
<img 
  src="/images/screenshots/prompt-library.png" 
  alt="Prompt performance tracking interface showing usage statistics and metrics" 
/>
...
<img 
  src="/images/screenshots/prompt-library.png" 
  alt="Integration interface showing how Prompt Library connects with other WISEPIM features" 
/>
