...
<img 
  src="/images/screenshots/process-tracker-overview.png" 
  alt="Process Tracker dashboard showing different task types and status indicators" 
/>
...
- **Manage Processes**: Cancel running tasks
...
<img 
  src="/images/screenshots/process-tracker-analytics.png" 
  alt="Process Tracker dashboard showing different task types and status indicators" 
/>
...
<img 
  src="/images/screenshots/process-tracker-management.png" 
  alt="Four-tab interface showing overview, task management, grid view, and analytics sections" 
/>
